...
```
127.0.0.1 abpcachingplayground-local-web
127.0.0.1 abpcachingplayground-local-webgateway
127.0.0.1 abpcachingplayground-local-authserver
```
...
Now, you can browse the URL: `https://abpcachingplayground-local-web`
