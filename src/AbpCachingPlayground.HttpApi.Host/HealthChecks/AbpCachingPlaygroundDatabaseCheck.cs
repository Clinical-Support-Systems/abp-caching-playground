...
public class AbpCachingPlaygroundDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public AbpCachingPlaygroundDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
