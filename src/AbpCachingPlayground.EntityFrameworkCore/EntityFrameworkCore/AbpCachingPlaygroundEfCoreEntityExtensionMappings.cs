...
public static class AbpCachingPlaygroundEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AbpCachingPlaygroundModuleExtensionConfigurator CLASS (in the Domain.Shared project)
